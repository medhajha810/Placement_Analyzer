...
export function AuthSignup() {
  ...
  const [role, setRole] = useState<'student' | 'company'>(roleParam as 'student' | 'company')
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-blue-900 flex flex-col items-center justify-center px-4">
      ...
      <Card className="w-full max-w-md border-slate-700 bg-slate-800">
        <CardHeader>
          ...
          <CardDescription>Join PathFinder and start your placement journey</CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs value={role} onValueChange={(v) => setRole(v as 'student' | 'company')} className="mb-6">
            ...
            <TabsContent value="student" className="text-sm text-slate-300 mt-2">
              Sign up as a student to find your perfect job match
            </TabsContent>
            <TabsContent value="company" className="text-sm text-slate-300 mt-2">
              Sign up as a company to find top talent
            </TabsContent>
          </Tabs>
